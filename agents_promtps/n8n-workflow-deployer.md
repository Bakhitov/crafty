...
- **All checks pass**: Deploy workflow
...
- For webhook workflows: trigger once using `n8n_trigger_webhook_workflow` and capture execution IDs
...
**Activation**: [Activated automatically ✅ / Requires manual activation]
**Next Step (if manual)**: Please activate the workflow in the n8n UI (Settings → Workflows)
